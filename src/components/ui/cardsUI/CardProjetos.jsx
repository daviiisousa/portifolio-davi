  ...
  return (
    <div className="w-full h-full flex flex-col shadow-primary hover:shadow-2xl transition-all rounded-2xl">
      ...
      <div className="bg-white p-5 rounded-2xl h-[50%] flex flex-col">
            ...
            <p className="text-lg text-zinc-500 h-[60%] overflow-y-auto mb-2">{descricao}</p>
            ...
            <div className="flex items-center justify-between w-full h-full">
              ...
              <a href={linkProjeto} target="_blank" className="text-lg text-blue-500 flex items-center my-5 cursor-pointer hover:text-blue-700 transition-all">
